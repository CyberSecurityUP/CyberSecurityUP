...
<?php
    ...
    $senha = "expersec{N4O_3SQU3Ç4_4S_CH4V3S}";
...
<div class="container">
	<h2><center>Bypass - O Administrador esqueceu a senha, efetue o bypass e descubra você mesmo</center></h2>	
	...
	<br><button class="w3-button w3-black w3-padding-large w3-large w3-margin-top" onclick="window.location.href='senha.html'">ACESSE A FLAG</button></br>
</div>
